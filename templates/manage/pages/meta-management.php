...
<form method="post" name="meta">
	...
	<p>
		<?php foreach($fw->meta()->getCode() as $c){?>
			<input type="radio" value="<?php echo $c['code'];?>s" name="code"> <?php echo $c['code'];?>  <br />
		<?php }?>
...
<hr />
	...
	<?php echo $ajax->bootpage(array('content'=>'.pagecontent','pagination'=> '.pagination', 'do'=>'ui_metadata.php','total'=> $fw->meta()->total()));?>